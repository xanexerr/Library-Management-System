...
<body style="background-color:#2F5597; 
    ...
    if (isset($_GET['search_query'])) {
        ...
        $stmt = $conn->prepare("SELECT * FROM users WHERE role='student' $order LIMIT :limit OFFSET :offset");
    }
                ...
                <div>
                    ...
                    <form class="m-0 rounded-top   col-12" method="GET">
                        <div class="input-group container bg-secondary px-4 p-2 py-3 mx-auto col-10">
                            ...
                            <input type="text" class="form-control  " placeholder="ค้นหา...." name="search_query" value="<?php if (isset($search_query)) {
                                echo $search_query;
                            }

                            ?>">
                            <button class="btn btn-primary rounded-0 px-3 mr-2 col-2" type="submit"
                                style="font-size: 1em;">
